...
![Me](../assets/images/vroger11_photo.webp){: align=left style="width: 100px; height: 100px;"}
...
PhD in Data Science since 2022 (for more information, I made [a blog post](blog/2022/10-30-my-phd-experience.md) about it).
...
I also perform data analysis to produce visualizations.
Most of them are available on my blog (and as a preview on [Reddit](https://www.reddit.com/user/vroger11)).
...
For more details, you can consult [my full résumé](../assets/cv/cv_en.pdf) or visit my [LinkedIn](https://www.linkedin.com/in/vroger11/).
